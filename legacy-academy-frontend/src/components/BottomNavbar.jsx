                ...
                <div className="bottom-nav-glass rounded-[28px]">
                    <div className="relative flex items-center justify-around py-3.5">
                        <button
                            ...
                            className={`nav-btn-glow flex flex-col items-center justify-center gap-1 px-2 py-1 transition-[color,transform] duration-200 active:scale-95 ${activeTab === 'home' ? 'text-white' : 'text-gray-400 hover:text-white'}`}
                        >
                        ...
                        <button
                            ...
                            className={`nav-btn-glow flex flex-col items-center justify-center gap-1 px-2 py-1 transition-[color,transform] duration-200 relative active:scale-95 ${activeTab === 'alerts' ? 'text-white' : 'text-gray-400 hover:text-white'}`}
                        >
                        ...
                        <button
                            ...
                            className={`nav-btn-glow flex flex-col items-center justify-center gap-1 px-2 py-1 transition-[color,transform] duration-200 active:scale-95 ${activeTab === 'search' ? 'text-white' : 'text-gray-400 hover:text-white'}`}
                        >
                        ...
                        <button
                            type="button"
                            onClick={onProfile}
                            className="nav-btn-glow flex flex-col items-center justify-center gap-1 px-2 py-1 transition-[color,transform] duration-200 text-gray-400 hover:text-white active:scale-95"
                        >

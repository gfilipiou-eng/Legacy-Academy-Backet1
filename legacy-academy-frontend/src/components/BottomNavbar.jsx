            ...
            <div className="flex justify-center px-3 sm:px-4 pt-4 pb-[calc(12px+env(safe-area-inset-bottom))] bg-black">
                ...
                >
                    <div className={navItemClass(activeTab === 'profile')}>     
                        <div className={`overflow-hidden bg-black transition-all duration-300 ${activeTab === 'profile' ? 'w-10 h-10 sm:w-11 sm:h-11 rounded-none border border-black/20 drop-shadow-md' : 'w-10 h-10 sm:w-11 sm:h-11 rounded-none border border-white/20 shadow-none'}`}>

    ...
    return (
        <div className="w-full h-full flex flex-col relative z-10 pt-safe mt-[80px] sm:mt-0">
            <div className="px-4 py-4 flex justify-between items-center sticky top-0 bg-[var(--app-bg)] z-20 border-b border-white/5">
                ...
                <button onClick={() => setIsCreateOpen(true)} className="bg-[var(--gold-primary)] text-black px-4 py-2 rounded-xl font-bold uppercase tracking-wider text-xs shadow-lg hover:opacity-90 active:scale-95 transition-all">
                    Create
                </button>
            </div>

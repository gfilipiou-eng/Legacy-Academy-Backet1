export const TRANSLATIONS = {
    en: {
        ...
        NOTIF_FOLLOW: 'followed you', NOTIF_LIKE: 'liked your post', NOTIF_COMMENT: 'commented on your post',
        ...
        TAB_ALL: 'ALL', TAB_POSTS: 'POSTS', TAB_VIDEO: 'VIDEO', HIGHLIGHTS: 'HIGHLIGHTS', NO_CONTENT: 'No Content Found',
        UPLOAD_TITLE: 'UPLOAD', DECRYPT_PH: 'Decrypt your thoughts...', YOUTUBE_PH: 'YouTube URL (optional)',
        YOUTUBE_NOTE: 'Note: YouTube links cannot be automatically verified for duration — please ensure the video is 10 minutes or shorter.',
        ADD_MEDIA: 'Add Media', ADD_STORY: 'Add to Story', STORY_DURATION: 'VISIBLE FOR 24H 🕒', POST_STORY: 'POST STORY',
    ...
    el: {
        ...
        NOTIF_FOLLOW: 'σε ακολούθησε', NOTIF_LIKE: 'του άρεσε η δημοσίευση', NOTIF_COMMENT: 'σχολίασε στην δημοσίευση',
    ...
    cy: {
        ...
        NOTIF_FOLLOW: 'se akolouthise', NOTIF_LIKE: 'arese to intel', NOTIF_COMMENT: 'evale sxolio',
        NOTIF_MESSAGE: 'minima', NOTIF_MENTION: 'se anefere', NOTIF_REQUEST: 'thelei mpei',
        AUTHORIZE: 'OK', DENY: 'OXI',
        SAVE: 'FULA KATO', CANCEL: 'AKYRO',
        FOLLOWING_LABEL: 'Akolouthei', EDIT_PROFILE: 'ALLAXE TO PROFIL', BAN: 'BAN 3D',
        ...
        ADD_MEDIA: 'Vale Foto', ADD_STORY: 'Vale Story', STORY_DURATION: 'THORITAI GIA 24H 🕒', POST_STORY: 'VALE STORY',
    ...
    de: {
        ...
        NOTIF_FOLLOW: 'folgt dir', NOTIF_LIKE: 'hat Intel bestätigt', NOTIF_COMMENT: 'kommentierte Beitrag',
        ...
        ADD_MEDIA: 'Medien', ADD_STORY: 'Zur Story', STORY_DURATION: 'SICHTBAR FÜR 24H 🕒', POST_STORY: 'STORY POSTEN',
    ...
    ru: {
        ...
        NOTIF_FOLLOW: 'подписался на вас', NOTIF_LIKE: 'одобрил данные', NOTIF_COMMENT: 'прокомментировал',
        ...
        ADD_MEDIA: 'Медиα', ADD_STORY: 'В Историю', STORY_DURATION: 'ВИДНО ВСЕГО 24Ч 🕒', POST_STORY: 'ОПУБЛИΚΟΒΑΤЬ',
    ...
    tr: {
        ...
        NOTIF_FOLLOW: 'seni takip etti', NOTIF_LIKE: 'beğendi', NOTIF_COMMENT: 'yorumladı',
    ...
    fr: {
        ...
        NOTIF_FOLLOW: 'vous a suivi', NOTIF_LIKE: 'a aimé', NOTIF_COMMENT: 'a commenté',
        ...
        ADD_MEDIA: 'Media', ADD_STORY: 'Story', STORY_DURATION: 'VISIBLE PENDANT 24H 🕒', POST_STORY: 'PUBLIER',

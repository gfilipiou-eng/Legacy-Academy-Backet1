        ...
        <div className="px-4 py-2 border-b border-white/10 mb-2">
          <div className="flex gap-3 sm:gap-4">
            <div className="shrink-0 flex flex-col items-center">
              <div 
                className="w-12 h-12 rounded-none overflow-hidden border border-white/10 shadow-lg cursor-pointer hover:opacity-80 transition-opacity"
            ...
            <div className="flex-1 flex flex-col min-w-0">
              <div className="flex flex-wrap items-center gap-x-1.5 gap-y-0.5 mb-2 min-w-0">
                ...
                <div className="flex items-center gap-1.5 shrink-0">
                  <span className="text-[12px] sm:text-[13px] font-black uppercase tracking-[0.1em] text-white/80 opacity-90 whitespace-nowrap">{formatDate(post.createdAt, t, lang).charAt(0).toUpperCase() + formatDate(post.createdAt, t, lang).slice(1)}</span>
                </div>
              </div>
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between mb-1">
                      <div className="flex items-center gap-2">
                        <span className="text-[11px] font-black text-white transition-colors cursor-pointer uppercase tracking-tight">{c.authorName}</span>
                        {(c.user?.role === 'Founder') ? (
                          <>

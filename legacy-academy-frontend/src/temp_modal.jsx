    ...
    <div className="fixed inset-0 z-[2000] flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-lg bg-[#111] border border-white/10 rounded-3xl p-6 shadow-2xl animate-pop-in">
        <div className="flex justify-between items-center mb-6">
          ...
          <button onClick={onClose} className="p-2 rounded-full transition-colors"><Icons.X className="w-6 h-6 text-gray-400" /></button>
        </div>
        ...
        <div className="flex items-center gap-3">
          {!audioBlob && !isRecording && (
            <button
              ...
              className="p-4 bg-white/5 border border-white/10 rounded-2xl text-gray-400  transition-all "
            >
          ...
          <button
            ...
            className="flex-1 py-4 bg-[var(--gold-primary)] text-black font-black text-sm uppercase tracking-widest rounded-2xl shadow-lg shadow-[var(--gold-primary)]/20  disabled:opacity-50 disabled:cursor-not-allowed transition-all flex items-center justify-center gap-2"
          >

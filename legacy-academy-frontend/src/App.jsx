                                    ...
                                    {activeTab === 'home' && (
                                        <div className="px-4 mb-2 flex flex-col items-center animate-fade-in relative z-10 scale-90 sm:scale-100">
                                            ...
                                            <div className="w-full max-w-2xl relative group mb-4">
                                                ...
                                                <div className="relative">
                                                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-white/90 group-focus-within:text-[var(--gold-primary)] transition-colors z-20 pointer-events-none">

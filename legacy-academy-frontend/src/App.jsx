...
const ProfileModal = ({
    ...
    {getActiveStreak(displayUser) > 0 && <span className="text-orange-500 font-bold ml-1">🔥 {getActiveStreak(displayUser)}</span>}</>)}</div>
    ...
    return (
        ...
        if (e.name === 'QuotaExceededError' || e.message?.toLowerCase()?.includes('quota')) {
              try {
                ...
                {/* PAYWALL MODAL */}
                {showPaywall && (
                    <div className="fixed inset-0 z-[5000] flex items-end md:items-center justify-center p-3 sm:p-4 bg-black/80 backdrop-blur-2xl">
                        <div className="relative bg-black/30 backdrop-blur-[60px] border border-white/15 rounded-[28px] md:rounded-[32px] max-w-[420px] w-full overflow-y-auto no-scrollbar max-h-[95dvh] shadow-2xl">
                            {/* Enhanced Liquid Glass Effects */}
                            <div className="absolute inset-0 bg-gradient-to-br from-white/10 via-transparent to-white/5 opacity-60 pointer-events-none" />
                            ...
                            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                                <div className="absolute -inset-full bg-gradient-to-r from-transparent via-white/10 to-transparent animate-[shimmer_4s_infinite]" />
                            </div>
                            
                            <div className="relative p-5 sm:p-8 text-center flex flex-col items-center">
                                {/* Icon with Glow */}
                                <div className="w-14 h-14 sm:w-20 sm:h-20 bg-[var(--gold-primary)]/15 rounded-full flex items-center justify-center mb-3 sm:mb-5 border border-[var(--gold-primary)]/30 shadow-[0_0_30px_rgba(255,215,0,0.15)]">
                                    <Icons.Lock className="w-6 h-6 sm:w-8 sm:h-8 text-[var(--gold-primary)]" />
                                </div>
                                
                                <h2 className="text-lg sm:text-[26px] font-black text-white uppercase tracking-[0.25em] mb-1 sm:mb-2">Exclusive Network</h2>
                                ...
                                <div className="bg-black/25 backdrop-blur-xl rounded-[20px] p-3.5 sm:p-5 w-full mb-4 sm:mb-7 border border-white/10 relative overflow-hidden">
                                ...
                                {/* CTA Button */}
                                <button onClick={() => window.location.href = "https://buy.stripe.com/aFaaEX81B2Fs1gI36Y6Na07"} className="w-full py-3.5 sm:py-4 bg-gradient-to-r from-[var(--gold-primary)] via-[#ffc700] to-[var(--gold-primary)] text-black font-black uppercase tracking-[0.3em] rounded-2xl hover:shadow-[0_0_30px_rgba(255,215,0,0.4)] active:scale-95 transition-all duration-300 mb-4 sm:mb-6 text-[10px] sm:text-[12px] relative overflow-hidden group">

...
const PostDetailModal = ({ post, user, allUsers, onClose, onLike, onDislike, onRepost, onOpenChat, onComment, onDelete, onEdit, onDeleteComment, onEditComment, onShare, loadingActions, onClearComments }) => {
    ...
    return (
        <div className="fixed inset-0 z-[2500] bg-black/98 backdrop-blur-3xl flex flex-col items-center justify-start md:justify-center p-0 md:p-4 overflow-hidden  duration-300">
            ...
            <div className="w-full max-w-6xl h-[100dvh] md:h-[90vh] bg-black/40 backdrop-blur-3xl rounded-none flex flex-col md:flex-row border-none md:border md:border-white/10 shrink-0 my-auto transform-gpu relative">
                {/* Image Section */}
                ...
                {/* Info Section */}
                <div className="w-full md:w-[450px] flex flex-col bg-transparent border-l border-white/5 flex-1 min-h-0 md:h-full relative font-sans">
                    <div className="p-3 sm:p-4 border-b border-white/20 flex items-center justify-between bg-transparent shrink-0 relative z-50 gap-2">
                    ...
                    <div className="flex-1 min-h-0 overflow-y-auto custom-scrollbar bg-black/30 overscroll-contain">
                        ...
                        {/* Description Section */}
                        <div className="px-4 sm:px-6 py-6 bg-transparent border-b border-white/20 z-10 relative">
                            ...
                            <div className="w-full px-3 sm:px-6 py-6 sm:py-4 flex items-center justify-between">
                                <div className="flex items-center gap-1 sm:gap-2">
                                    <EnhancedButton
                                        ...
                                        className="relative min-w-[44px] min-h-[44px] flex items-center justify-center rounded-none bg-black border border-white/20 transition-all duration-300 z-50 p-2.5 -ml-2 group overflow-hidden"

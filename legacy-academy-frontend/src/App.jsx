...
const BACKGROUND_MODES = [
    ...
    { value: 'pink-aesthetic', labelKey: 'PINK_AESTHETIC_MODE', color: '#4a0d2a', className: 'bg-pink-aesthetic' },
    { value: 'razer-green', labelKey: 'RAZER_GREEN_MODE', color: '#092e11', className: 'bg-razer-green' },
];

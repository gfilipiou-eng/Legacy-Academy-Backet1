...
const VerifiedBadge = ({ isFounder, className = "w-4 h-4" }) => {
    if (isFounder) {
        return (
            <svg viewBox="0 0 24 24" className={`${className} shrink-0 drop-shadow-[0_0_6px_rgba(255,215,0,0.7)]`}>
                <path fill="#FFD700" d="M13.101 4.533L11 2.5 8.899 4.533l-2.895-.41-.505 2.88-2.583 1.37L4.2 11l-1.284 2.627 2.583 1.37.505 2.88 2.895-.41L11 19.5l2.101-2.033 2.895.41.505-2.88 2.583-1.37L17.8 11l1.284-2.627-2.583-1.37-.505-2.88zm-6.868 6.89l3.429 3.428 5.683-6.206-1.347-1.247-4.4 4.795-2.072-2.072z" />
            </svg>
        );
    }
    return (
        <svg viewBox="0 0 22 22" className={`${className} shrink-0 drop-shadow-[0_0_4px_rgba(29,155,240,0.6)]`}>

    ...
    return (
        <div className="fixed inset-0 z-[2000] flex items-center justify-center p-4">
            ...
            <div className="relative w-full sm:max-w-lg bg-black/80 backdrop-blur-3xl border border-white/10 rounded-3xl p-6 shadow-2xl animate-pop-in safe-area-bottom">
                ...
                {audioBlob ? (
                    <div className="flex items-center justify-between p-4 bg-[var(--gold-primary)]/10 border border-[var(--gold-primary)]/30 rounded-2xl mb-6 shadow-[0_0_30px_rgba(212,175,55,0.1)]">
                    ...
                    <div className="flex items-center justify-between p-6 bg-red-500/10 border border-red-500/30 rounded-2xl mb-6 animate-pulse shadow-[0_0_30px_rgba(239,68,68,0.2)]">
                        <div className="flex items-center gap-3">
                        ...
                        <button onClick={stopRecording} className="px-6 py-2 bg-red-500 text-white font-black text-xs uppercase tracking-widest rounded-xl shadow-lg active:scale-95 transition-all hover:bg-red-600">{t('STOP')}</button>
                    </div>
                ) : (
                    <textarea
                        autoFocus
                        ...
                        className="w-full h-40 bg-black/50 border border-white/10 rounded-2xl p-4 text-base sm:text-lg text-white font-medium resize-none focus:border-[var(--gold-primary)] outline-none mb-6 placeholder-gray-600 shadow-inner"
                    />
                )}
                ...
                <div className="flex items-center gap-3">
                    {!audioBlob && !isRecording && (
                        <button
                            ...
                            className="p-4 bg-white/5 border border-white/10 rounded-2xl text-gray-400 hover:text-[var(--gold-primary)] hover:border-[var(--gold-primary)]/30 transition-all hover:bg-white/10 active:scale-95 shadow-lg"
                        >
                    ...
                    <button
                        ...
                        className="flex-1 py-4 bg-[var(--gold-primary)] text-black font-black text-sm uppercase tracking-widest rounded-2xl shadow-[0_4px_20px_rgba(212,175,55,0.3)] hover:shadow-[0_6px_25px_rgba(212,175,55,0.4)] active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed transition-all flex items-center justify-center gap-2 hover:brightness-110"
                    >

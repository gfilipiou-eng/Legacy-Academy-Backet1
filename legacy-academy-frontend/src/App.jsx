    ...
    return (
        ...
        <div className="fixed inset-0 z-[2100] flex items-end sm:items-center justify-center overflow-x-hidden">
            ...
            <motion.div 
                ...
                style={{ width: '100%', maxWidth: '100%', boxSizing: 'border-box', overflow: 'hidden', contain: 'layout paint size', position: 'relative' }}>
                ...
                <div className={`flex-1 overflow-y-auto overflow-x-hidden custom-scrollbar relative overscroll-y-contain pb-20 z-10 bg-transparent w-full max-w-full box-border`} style={{ width: '100%', maxWidth: '100%', boxSizing: 'border-box', overflowX: 'hidden', overflowY: 'auto', overscrollBehaviorY: 'contain', contain: 'layout paint size', position: 'relative' }}>
                    {activeList ? (
                        ...
                        <div className="p-6 space-y-8 animate-fade-in w-full max-w-full box-border" style={{ width: '100%', maxWidth: '100%', boxSizing: 'border-box', position: 'relative', overflow: 'hidden', contain: 'layout paint size' }}>
